...
export const experiments: Experiment[] = [
  ...
  { name: 'lipsync-mlx', area: 'AI Video', status: 'EXPERIMENT', glyph: 'wave', line: 'LatentSync 1.5 ported to Apple silicon, with a sampler that runs 2.73× faster at 8 steps.' },
  ...
  { name: 'FrameForge', area: 'Creative Automation', status: 'PROTOTYPE', glyph: 'bars', line: 'A video editor you instruct in plain English. 80+ actions on MoviePy and Ollama.' },
  { name: 'Articast', area: 'Creative Automation', status: 'IN PROGRESS', glyph: 'type', line: 'Paste an article, get a narrated, captioned video. Remotion with word-timed speech.' },
  ...
  { name: 'IndicF5 Studio', area: 'Local AI', status: 'EXPERIMENT', glyph: 'wave', line: 'Indian-language voice cloning with a podcast UI and an API.' },
...
export const works: Record<string, Work> = {
  ...
  lipsync: { id: 'lipsync', name: 'lipsync-mlx' },
...
export const tech: (TechNode & { uses: (keyof typeof works)[] })[] = [
  ...
  { id: 'ffmpeg', label: 'FFmpeg', x: 150, y: 470, uses: ['dub', 'relay', 'h2v'] },
